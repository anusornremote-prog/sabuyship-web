...
## 7. E2E Browser Testing & Automation
- **Clear Inputs Before Typing:** เมื่อใช้งาน `browser_subagent` หรือเขียนสคริปต์เทสเพื่อพิมพ์ข้อมูลลงในฟอร์ม (เช่น หน้า Login) **ต้องสั่งให้เคลียร์ข้อมูลเดิมในช่องนั้นๆ (ลบช่องว่าง/ข้อมูลเก่า) ก่อนพิมพ์ใหม่เสมอ** เนื่องจากบราวเซอร์อาจมีการจดจำรหัสผ่านหรือมี Auto-fill ค้างไว้ หากพิมพ์ไปโดยไม่ลบก่อนจะทำให้พิมพ์ต่อท้ายข้อมูลเดิมและระบบแจ้งเตือนว่ารหัสผ่านผิด
